  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><b>
             <h1 style="color:red;font-size:40px;">Reports</h1>
      </h1>
      <ol class="breadcrumb">
  ...
  <script type="text/javascript">
    ...
    barChartData.datasets[0].fillColor   = '#d22b2b';
    barChartData.datasets[0].strokeColor = '#d22b2b';
    barChartData.datasets[0].pointColor  = '#d22b2b';
    var barChartOptions                  = {
