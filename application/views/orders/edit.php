...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1><b>
      <h1 style="color:red;font-size:40px;">Edit Order</h1>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'orders/printDiv/'.$order_data['order']['id'] ?>" class="btn btn-danger" >Print</a>
